...
@Component({
  tag: 'o-forgot-password',
  styleUrl: 'o-forgot-password.css',
  shadow: true,
})
export class OForgotPassword {
  form: HTMLFormElement;
  formControls: IFormControl[];

  @Element()
  host: HTMLOForgotPasswordElement;
  ...
  async submit() {
    ...
    this.formResponse = await AuthenticationService
      .forgotPassword(formDataObject as IForgotPasswordAuthenticationRequest);
